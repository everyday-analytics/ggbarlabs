...
But x becomes numeric, so we have to put the category back on.  Right now seems fragile - but if we can recover cut_types at a 'before_stat' or something, that would be pretty cool.  The coord_flip() makes everything feel confusing to talk about. lol.
